...
//
const AboutImage = "/newHomePageImages/about_image.png"
const comma = "/newHomePageImages/comma.png"
                    ...
                    <Row>
                        <Col lg={12} className={styles.hover1}>
                            ...
                            <div className={` ${styles.client} sec_image text-center`}>
                                <Image quality={75} src={AboutImage} width={800} height={600} alt='Banner' className={styles.secImage} />


                                <div onMouseEnter={() => fun1('active')}
                                    onMouseLeave={() => fun2('secImage1')} className={isHovered == 'active' ? styles.active : styles.secImage1}>
                                    <Image src={comma} width={30} height={30} alt='BitsWits' className='img-fluid' />
