  ...
  return (
    <>
      <div className={styles[props.formsaspire]}>
        <h4 className="t-center font30 fw500 colortextgrey font-f">
          Get A Free Quote
        </h4>
        ...
        <form className={styles.formalign} onSubmit={handleSubmit}>
          ...
          ></textarea>
          <button
            className={`bitsForm ${styles.freebtn}`}
            type="submit"
            disabled={isDisabled}
          >
            {score}
        ...
        {props.show ? (
          <div className="mt-4">
            <a
              className={styles.freediscuss}
              href="javascript:window.replaceChat();"
            >
              LET'S DISCUSS
            </a>
            <a className={styles.freehomenumer} href="tel:(213) 289 3888">
              (213) 289 3888
            </a>
          </div>
        ) : (
