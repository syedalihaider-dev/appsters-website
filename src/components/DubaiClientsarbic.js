...
const DubaiClientArbic = ({ content }) => {
            ...
            <Col md={6} lg={4}>
              <div className={styles.trustPilot}>
                ...
                <div>
                  ...
                  <p className={`${styles.clientsPara} fontsfregular`}>
                    based on 20+ clients
                  </p>
                </div>
              </div>
                  ...
                  <div className={`card ${styles.card}`}>
                    <div className={`${styles.cardTop}`}>
                      <div className='name d-flex flex-column'>
                        ...
                        <span>لرياض، المملكة العربية السعودية</span>
                      </div>
                      <div>
...
export default DubaiClientArbic;
